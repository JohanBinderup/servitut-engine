    ...
    *,
    ...
    for i, item in enumerate(extracted):
        ...
        servitut = Servitut(
            ...
            supplementary_text=coerce_optional_str(item.get("supplementary_text")),
            other_properties_count=item.get("other_properties_count"),
            priority_text=coerce_optional_str(item.get("priority_text")),
